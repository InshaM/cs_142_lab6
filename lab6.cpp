	...
	public:
		...
		void insertHelper(Node * current, int value){
			...
			//Else compare the current data with value
				...
				//otherwise move right and call insert
...
int main(){
	BiST t1;
	int k,n,x;
	cout<<"How many number of elements do you want?"; cin>>n; cout<<endl;
	...
	t1.display();
	cout<<"Do you want to search whether any element exist ?: Type the element you want to search : ";
	cin>>x;cout<<endl;
	t1.search(x);
}
